...
class LatestNewsControllerTest < ActionController::TestCase
  ...
  test "should create latest_news" do
    assert_difference('LatestNews.count') do
      post :create, latest_news: { content: @latest_news.content, heading: @latest_news.heading, subheading: @latest_news.subheading }
    end
  ...
  test "should update latest_news" do
    patch :update, id: @latest_news, latest_news: { content: @latest_news.content, heading: @latest_news.heading, subheading: @latest_news.subheading }
    assert_redirected_to latest_news_path(assigns(:latest_news))
  end
